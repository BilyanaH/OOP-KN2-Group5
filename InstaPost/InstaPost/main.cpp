...
void createArrayOfPosts(const char* fileName)
{
    ...
    InstaPost ip1("This ASCII art shows a basic representation of a human face, with eyes, nose, and mouth. The face is looking straight ahead, and the mouth is curved into a slight smile. I hope you like it!", 0,"selfie.photo");
    ip1.like();
